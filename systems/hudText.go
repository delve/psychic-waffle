...
// HUDMoneyMessageType is the type for a HUDMoneyMessage
...
// HUDTextSystem print the text to our HUD based on the current state of the game
...
func (h *HUDTextSystem) New(w *ecs.World) {
	...
	h.text1.RenderComponent.SetZIndex(globals.HUDZ + 1)
	...
	h.text2.RenderComponent.Drawable = common.Text{
		Font: fnt,
		Text: "Click on something",
	}
	h.text2.SetShader(common.TextHUDShader)
	h.text2.RenderComponent.SetZIndex(globals.HUDZ + 1)
	h.text2.SpaceComponent = common.SpaceComponent{
		Position: engo.Point{X: 0, Y: engo.WindowHeight() - globals.HUDHeight + 20},
	}
	...
	h.text3.RenderComponent.SetZIndex(globals.HUDZ + 1)
	h.text3.SpaceComponent = common.SpaceComponent{
		Position: engo.Point{X: 0, Y: engo.WindowHeight() - globals.HUDHeight + 40},
	}
	...
	h.text4.RenderComponent.SetZIndex(globals.HUDZ + 1)
	h.text4.SpaceComponent = common.SpaceComponent{
		Position: engo.Point{X: 0, Y: engo.WindowHeight() - globals.HUDHeight + 60},
	}
	...
	h.money.RenderComponent.SetZIndex(globals.HUDZ + 1)
	h.money.SpaceComponent = common.SpaceComponent{
		Position: engo.Point{X: 0, Y: engo.WindowHeight() - globals.HUDHeight + 160},
	}
...
// Update is called each frame to update this system
